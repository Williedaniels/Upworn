        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="w-full lg:w-1/2 mb-8 lg:mb-0 lg:pr-8">
            ...
            <div className="flex flex-col sm:flex-row gap-6 sm:gap-10">
              <a href="#contact" className="border border-black text-black text-base sm:text-lg px-4 sm:px-6 py-2.5 rounded-full flex items-center justify-center hover:scale-105">
                Join Upworn Now
